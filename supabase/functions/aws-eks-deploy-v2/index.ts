...
// AWS SDK v3 for Deno - using npm: specifier
import { EKSClient, CreateClusterCommand, DescribeClusterCommand, ListClustersCommand, DeleteClusterCommand, UpdateClusterConfigCommand } from "npm:@aws-sdk/client-eks@3"
